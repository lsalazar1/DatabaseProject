CREATE TABLE State( StID INT, StateName Varchar(32), Country Varchar(32), PRIMARY KEY(StID), CONTRAINT fk_Country FOREIGN KEY (Country) REFERENCES Countries (CtId));
